[![Build Status](https://travis-ci.org/ComputationWithBoundedResources/tct-its.svg?branch=master)](https://travis-ci.org/ComputationWithBoundedResources/tct-its)
